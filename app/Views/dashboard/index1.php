...
<div class="container-fluid position-relative">
    ...
    <div class="row g-0">
        <!-- Sidebar -->
        <div class="col-md-3 nav flex-column nav-pills p-2" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <button class="nav-link active mb-1 text-start" id="v-pills-informasi-tab" data-bs-toggle="pill" data-bs-target="#v-pills-informasi" type="button" role="tab" aria-controls="v-pills-informasi" aria-selected="true">Informasi</button>
            ...
            <button class="nav-link mb-1 text-start" id="v-pills-petunjuk-tab" data-bs-toggle="pill" data-bs-target="#v-pills-petunjuk" type="button" role="tab" aria-controls="v-pills-petunjuk" aria-selected="false">Petunjuk Pembayaran</button>
            <div class="collapse submenu1 ps-4 mt-1 mb-1" id="submenu-petunjuk">
                <div class="nav nav-pills flex-column">
                    ...
                    <div class="collapse ps-4 mt-1 mb-1" id="petunjuk-submenu">
                        <div class="nav flex-column">
            ...
            <button class="nav-link mb-1 text-start" id="v-pills-perpajakan-tab" data-bs-toggle="pill" data-bs-target="#v-pills-perpajakan" type="button" role="tab" aria-controls="v-pills-perpajakan" aria-selected="false">Perpajakan</button>
            ...
            <button class="nav-link mb-1 text-start" id="v-pills-open-tab" data-bs-toggle="pill" data-bs-target="#v-pills-open" type="button" role="tab" aria-controls="v-pills-open" aria-selected="false">Open Item</button>
            ...
            <button class="nav-link mb-1 text-start" id="v-pills-buktipotong-tab" data-bs-toggle="pill" data-bs-target="#v-pills-buktipotong" type="button" role="tab" aria-controls="v-pills-buktipotong" aria-selected="false">Bukti Potong</button>
        ...
        <div class="col-md tab-content ps-1 border-start border-dark-subtle" id="v-pills-tabContent">
            ...
            <div class="tab-pane fade" id="v-pills-petunjuk" role="tabpanel" aria-labelledby="v-pills-petunjuk-tab" tabindex="0">
                <div class="row" style="margin-left: 0px; margin-right: 0px; min-height: 70vh;">
