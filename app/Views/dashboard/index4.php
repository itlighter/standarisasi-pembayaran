    ...
    <div class="row g-0">
        ...
        <div id="sidebar-wrapper" class="col-md-3 position-relative">
            <div class="nav flex-column nav-pills p-2" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <hr>
                <button class="nav-link active d-flex align-items-center gap-2" id="v-pills-informasi-tab" data-bs-toggle="pill" data-bs-target="#v-pills-informasi" type="button" role="tab" aria-controls="v-pills-informasi" aria-selected="true" title="Informasi" data-bs-toggle="tooltip">
                ...
                <button class="nav-link d-flex align-items-center gap-2" id="v-pills-petunjuk-tab" data-bs-toggle="pill" data-bs-target="#v-pills-petunjuk" type="button" role="tab" aria-controls="v-pills-petunjuk" aria-selected="true">
                ...
                <button class="nav-link d-flex align-items-center gap-2" id="v-pills-perpajakan-tab" data-bs-toggle="pill" data-bs-target="#v-pills-perpajakan" type="button" role="tab" aria-controls="v-pills-perpajakan" aria-selected="true">
                    <img src="<?= base_url('image/pajak.png') ?>" width="25" height="25">
                    <span class="menu-label d-inline">Perpajakan</span>
                </button>
                ...
                <button class="nav-link d-flex align-items-center gap-2" id="v-pills-open-tab" data-bs-toggle="pill" data-bs-target="#v-pills-open" type="button" role="tab" aria-controls="v-pills-open" aria-selected="true">
                ...
                <button class="nav-link d-flex align-items-center gap-2" id="v-pills-buktipotong-tab" data-bs-toggle="pill" data-bs-target="#v-pills-buktipotong" type="button" role="tab" aria-controls="v-pills-buktipotong" aria-selected="true">
                        ...
                        <div class="row" style="margin-left: -5px;">
                            <div class="col me-3 border border-1 ps-3 pt-3 pe-3">
                                <div class="ps-2 pt-2 border border-1 mb-2 position-relative">
                                    ...
                                    <a href="/dashboard/petunjuk/sewa/3" class="stretched-link"></a>
                                </div>
