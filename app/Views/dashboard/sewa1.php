...
<div class="container-fluid position-relative">
    <div class="text-start" id="sidebar-icon1" style="min-height: 70vh; width: 30px;">
        <img src="<?= base_url('image/sidebar-2.svg') ?>" width="30" height="30" alt="sidebar-icon" class="position-sticky top-0">
    </div>
    <div class="row g-0">
        <!-- Sidebar -->
        <div class="col-md-3 h-100 nav flex-column nav-pills position-sticky top-0 p-2" id="v-pills-tab" role="tablist" aria-orientation="vertical" style="min-height:inherit;">
            <button class="nav-link mb-1 text-start" id="v-pills-informasi-tab" data-bs-toggle="collapse" data-bs-target="#submenu-informasi" type="button" role="button" aria-controls="submenu-informasi" aria-expanded="false">Informasi</button>
            ...
            <button class="nav-link active text-start" id="v-pills-petunjuk-tab" data-bs-toggle="collapse" data-bs-target="#submenu-petunjuk" type="button" role="button" aria-controls="submenu-informasi" aria-expanded="false">Petunjuk Pembayaran</button>
            <div class="collapse show ps-4 mt-1 mb-1" id="submenu-petunjuk">
                <div class="nav nav-pills flex-column">
                    ...
                    <div class="collapse show ps-4 mt-1 mb-1" id="petunjuk-submenu">
                        <div class="nav flex-column">
                            <a class="nav-link active" href="<?= base_url("dashboard/petunjuk/sewa") ?>" id="proses">Proses</a>
            ...
            <button class="nav-link mb-1 text-start text-primary" id="v-pills-perpajakan-tab" data-bs-toggle="collapse" data-bs-target="#submenu-perpajakan" type="button" role="button" aria-controls="submenu-perpajakan" aria-expanded="false">Perpajakan</button>
            ...
            <button class="nav-link mb-1 text-start text-primary" id="v-pills-opitem-tab" data-bs-toggle="collapse" data-bs-target="#submenu-opitem" type="button" role="button" aria-controls="submenu-opitem" aria-expanded="false">Open Item</button>
            ...
            <button class="nav-link mb-1 text-start text-primary" id="v-pills-buktipotong-tab" data-bs-toggle="collapse" data-bs-target="#submenu-buktipotong" type="button" role="button" aria-controls="submenu-buktipotong" aria-expanded="false">Bukti Potong</button>
