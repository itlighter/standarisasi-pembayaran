...
<div class="d-flex position-relative mt-5 bg-image" id="bg-image" style="padding-left: 95px;">
    <div class="border border-1 rounded-4 border-primary" style="width: 400px; height: 545px;">
        <p class="text-center text-primary mt-5" style="font-size: 24px;">Standarisasi Pembayaran</p>
        <h3 class="text-center" style="margin-top: 30px; margin-bottom: 40px; color: gray; font-size: 22px;">Login</h3>
