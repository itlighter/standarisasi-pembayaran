            ...
            <table class="table table-white table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="collapse-fsize2">
                            <img class="myImg" src="<?= base_url('image/Picture5.png') ?>" alt="DSP OHC" style="width:100%;max-width:239px">
                            <div class="modalImg">
            ...
            <table class="table table-white table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="collapse-fsize2">DSP OHC</td>
                        <td class="collapse-fsize2">
                            <img class="myImg" src="<?= base_url('image/Picture5.png') ?>" alt="DSP Sewa" style="width:100%;max-width:239px">
                            <div class="modalImg">
                                <span class="close">&times;</span>
                                <img class="modal-content">
                                <div class="caption"></div>
